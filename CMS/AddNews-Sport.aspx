...
<script runat="server">
    ...
    Protected Sub btnSave_Click(ByVal sender As Object, ByVal e As System.EventArgs)
        Try
            ...
            StrSql = "INSERT INTO tblNews (Date, Titr, Lid, Text, PhotoName, NewsType) VALUES (@Date, @Titr, @Lid, @Text, @PhotoName, 3)"
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <center>
        &nbsp;</center>
    <center>
        <asp:Label Font-Bold="False" Font-Size="X-Large" ID="Label2" runat="server" Text="قسمت افزودن اخبار  ورزشی اتحادیه"></asp:Label>&nbsp;</center>
    <center>
        &nbsp;</center>
    <center>
        <table>
